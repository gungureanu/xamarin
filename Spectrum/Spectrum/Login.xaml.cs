    ...
    public partial class Login : ContentPage
    {
        ...
        private async void Login_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    await DisplayAlert("Email Address and Password is required", "Please enter the Email address and Password in order to login the Spectrum app", "OK");
                    ...
                    using (UserDialogs.Instance.Loading("Authenticating..."))
                    {
                        ...
                        if (objProfile != null)
                        {
                            if (objProfile.UserExists.ToLower() == "trialrunning" || objProfile.UserExists.ToLower() == "success")
                            {
                                ...
                                Application.Current.Properties["UserName"] = Convert.ToString(objProfile.FirstName);
                                ...
                                //Navigation.InsertPageBefore(new Spectrum.View.MasterPages.HomeMasterDetailPage(objProfile, lstModules, "chat", null), this);
                                Navigation.InsertPageBefore(new Spectrum.View.MasterPages.HomeMasterDetailPage(objProfile, lstModules, "projects", null), this);
                                ...
                                //Navigation.InsertPageBefore(new Spectrum.View.MasterPages.HomeMasterDetailPage(objProfile, lstModules, "Workspaces", null), this);
                                  //Navigation.InsertPageBefore(new Spectrum.View.MasterPages.HomeMasterDetailPage(objProfile, lstModules, "Punch Card", null), this);
                            ...
                            else
                            {
                                ...
                                {
                                    await DisplayAlert("Success", "Your Spectrum.com account is not yet verified. Please check your email(inbox/junk folder) and verify your account", "OK");
                                }
