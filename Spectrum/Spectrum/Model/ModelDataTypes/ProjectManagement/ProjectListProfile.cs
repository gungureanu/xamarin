...
{
    public class ProjectListProfile : BaseEntity
    {
    ...
    public class ProjectScheduleFrom : BaseEntity
    {
        public Int64 ProjectID { get; set; }
        public Guid CompanyID { get; set; }
        public Guid AccountID { get; set; }
        public Int32 WorkSpaceID { get; set; }
        public int ScheduleFromID { get; set; }
        public int ModuleID { get; set; }
        public string ScheduleFrom { get; set; }
        public string ScheduleFromDescription { get; set; }
        public bool Active { get; set; }
