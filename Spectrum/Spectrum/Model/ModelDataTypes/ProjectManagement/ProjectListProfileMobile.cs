...
using Spectrum.Model.ModelDataTypes.SpectrumInvoice;

namespace Spectrum.Model.ModelDataTypes
{
    public class ProjectListProfileMobile : BaseEntity
    {
        ...
        public CustomerMesssage objMessage = new CustomerMesssage();
    }
}
